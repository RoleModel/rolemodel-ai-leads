...
2. Flow
   ...
   2. Explain estimated time to complete (3–5 minutes).
   3. Highlight that AI guidance and curated resources are provided.
   2. Initial Contact Capture
   1. Minimal gate: Name + Email (ensures lead capture early).
   2. Could use soft wording: “We’ll email you a summary of your results plus helpful insights.”
   3. Structured Qualification Form
   1. Core BANT + business goal questions: Budget, Authority, Need, Timeline, desired outcomes.
   2. Predefined multiple-choice or short free-text inputs.
   4. AI Highlights / Contextualization
   1. AI reviews the user’s responses behind the scenes.
   2. Generates dynamic recommendations, clarifying hints, or links to relevant content:
   1. Suggests relevant ROI guides or case studies.
   2. Provides contextual examples if the user’s answer is vague.
   3. Optional: subtle “next step” messaging: “Based on your inputs, a custom solution could accelerate X—here’s how RoleModel has helped others.”
   5. Qualification Summary
   1. Structured output: BANT + business goal context + AI insights.
   2. Offer email summary to prospect and webhook submission to CRM.
   6. Call-to-Action
   1. Clearly recommend scheduling a call via Calendly.
   2. AI can highlight the value: “We can explore how your business can achieve similar ROI through a personalized consultation.”
