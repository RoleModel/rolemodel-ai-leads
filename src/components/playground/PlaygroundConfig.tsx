    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Button variant="secondary" size="sm" onClick={() => router.push('/playground/compare')}>
            Compare
          </Button>
        </div>
        ...
        <div style={{ marginBottom: 'var(--op-space-large)' }}>
          <label htmlFor="playground-model" style={{
            display: 'block',
            fontSize: 'var(--op-font-small)',
            fontWeight: 'var(--op-font-weight-medium)',
        ...
        <div style={{ marginBottom: 'var(--op-space-large)' }}>
          <div style={{
            ...
            <label htmlFor="playground-temperature" style={{
              fontSize: 'var(--op-font-small)',
              fontWeight: 'var(--op-font-weight-medium)',
            }}>
              Temperature
        ...
        <div>
          <div style={{
            ...
            <label htmlFor="playground-instructions" style={{
              fontSize: 'var(--op-font-small)',
              fontWeight: 'var(--op-font-weight-medium)',
            }}>
