...
export interface ButtonProps
  ...
  variant?: "primary" | "secondary" | "ghost" | "destructive" | "icon" | "ghosticon" | "pill" | "dashed" | "dashedpill"
  size?: "sm" | "md" | "lg"
  width?: "full"
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "primary", size = "md", width = "full-width", justify = "center", className, ...props }, ref) => {
    const variantClass =
      {
    ...
    return (
      <button
        ref={ref}
        href={props.href}
        style={variant === "dashed" || variant === "dashedpill" ? dashedBorderStyle : undefined}
